...
parser.add_argument('--data-dir', default='/content/data/txt/europarl/train_data.pkl', type=str)
parser.add_argument('--vocab-file', default='/content/data/txt/europarl/vocab.json', type=str)
parser.add_argument('--checkpoint-path', default='/content/data/txt/europarl/checkpoints/deepsc-Rayleigh', type=str)
